...
import { DefaultValue as FallbackValue, MiddlewareMarker, Overwrite, UnsetMarker } from './internals/utils';
...
export interface MiddlewareBuilder<TRoot extends ProcedureParams, TNewParams extends ProcedureParams> {
    ...
    unstable_pipe<$Params extends ProcedureParams>(fn: {
        ...
        _input_out: UnsetMarker extends TNewParams['_input_out'] ? TRoot['_input_out'] : Overwrite<TRoot['_input_out'], TNewParams['_input_out']>;
